...
public class JobMain extends Configured implements Tool {
    ...
    private static String localPathInput = "/Users/chenyouhong/Desktop/test/flow_sort";
...
//        TextInputFormat.addInputPath(job, new Path(pathInput));
        ...
        job.setMapperClass(FlowCounterSortMapper.class);
        job.setMapOutputKeyClass(FlowBean.class);
        job.setMapOutputValueClass(Text.class);

        job.setReducerClass(FlowCounterSortReducer.class);
